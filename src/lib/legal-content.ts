...
export const LEGAL_COMPANY = {
  companyName: "Lohnbuchhaltung Schmidt / Norek",
...
> = {
  de: {
    impressum: {
      eyebrow: "Rechtliches",
      title: "Impressum",
      intro: "Angaben zum Anbieter und zu den verantwortlichen Stellen von Norek.",
      sections: [
        {
        ...
        },
        {
          title: "Hinweis",
          paragraphs: [
            "Norek ist eine Plattform für Challenges, Community-Voting und zahlungsbezogene Plattformleistungen. Rechtlich verbindliche Erklärungen zu Verträgen, Auszahlungen, Gebühren und Nutzerpflichten ergeben sich ergänzend aus den AGB, der Datenschutzerklärung, der Widerrufsbelehrung, der Preis-/Gebührenübersicht und der Auszahlungsrichtlinie.",
          ],
        },
      ],
    },
    ...
    datenschutz: {
      ...
      intro: "Informationen darüber, wie personenbezogene Daten bei Norek verarbeitet werden.",
      sections: [
        {
    ...
    widerruf: {
      ...
      intro: "Informationen zum gesetzlichen Widerrufsrecht bei Norek.",
      sections: [
        {
          title: "Widerrufsbelehrung",
          paragraphs: [
    ...
    preise: {
      ...
      intro: "Übersicht über Preise, Gebühren und Grundmechanik von Zahlungen auf Norek.",
      sections: [
        {
          title: "1. Grundmodell",
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            "Sofern nicht ausdrücklich anders ausgewiesen, handelt es sich bei Support-Zahlungen nicht um steuerlich abzugsfähige Spenden, sondern um plattformbezogene Zahlungen im Rahmen der Norek-Mechanik.",
          ],
        },
      ],
    },
    ...
    auszahlungsrichtlinie: {
      ...
      intro: "Regeln und Voraussetzungen für Auszahlungen auf Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Norek darf Auszahlungen zurückhalten, prüfen, ablehnen oder korrigieren, wenn rechtliche, regulatorische, technische, sicherheitsrelevante oder vertragliche Gründe dies erforderlich machen.",
        ...
        },
        {
          ...
          paragraphs: [
            "Empfänger von Auszahlungen sind selbst dafür verantwortlich, erhaltene Beträge steuerlich korrekt einzuordnen und zu erklären. Norek schuldet keine individuelle Steuerberatung.",
          ],
        },
        {
          title: "6. Rückforderung / Aufrechnung",
          paragraphs: [
            "Norek kann fehlerhafte oder unberechtigte Auszahlungen zurückfordern, mit künftigen Auszahlungen verrechnen oder über den Zahlungsdienstleister rückabwickeln, soweit dies rechtlich zulässig ist.",
          ],
        },
      ],
    },
  ...
  en: {
    impressum: {
      eyebrow: "Legal",
      title: "Legal notice",
      intro: "Provider and responsible entity information for Norek.",
      sections: [
        {
        ...
        },
        {
          title: "Notice",
          paragraphs: [
            "Norek is a platform for challenges, community voting and payment-related platform services. Legally binding statements regarding contracts, payouts, fees and user obligations are additionally governed by the Terms and Conditions, Privacy Policy, Withdrawal Policy, Pricing / Fee Overview and Payout Policy.",
          ],
        },
      ],
    },
    ...
    datenschutz: {
      ...
      intro: "Information about how personal data is processed on Norek.",
      sections: [
        {
          title: "1. Controller",
          paragraphs: [
    ...
    widerruf: {
      ...
      intro: "Information on the statutory right of withdrawal for Norek.",
      sections: [
        {
          title: "Withdrawal policy",
          paragraphs: [
    ...
    preise: {
      ...
      intro: "Overview of prices, fees and the core payment mechanics on Norek.",
      sections: [
        {
          title: "1. Basic model",
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            "Unless explicitly stated otherwise, support payments are not tax-deductible donations but platform-related payments within the Norek mechanics.",
          ],
        },
      ],
    },
    ...
    auszahlungsrichtlinie: {
      eyebrow: "Legal",
      title: "Payout policy",
      intro: "Rules and requirements for payouts on Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Norek may withhold, review, reject or correct payouts where this is necessary for legal, regulatory, technical, security-related or contractual reasons.",
        ...
        },
        {
          title: "5. Tax notice",
          paragraphs: [
            "Recipients of payouts are solely responsible for classifying and declaring received amounts correctly for tax purposes. Norek does not provide individual tax advice.",
          ],
        },
        {
          title: "6. Recovery / set-off",
          paragraphs: [
            "Norek may reclaim incorrect or unauthorized payouts, offset them against future payouts or reverse them via the payment service provider to the extent permitted by law.",
          ],
        },
      ],
    },
  ...
  es: {
    impressum: {
      eyebrow: "Legal",
      title: "Aviso legal",
      intro: "Información sobre el proveedor y las entidades responsables de Norek.",
      sections: [
        {
    ...
    datenschutz: {
      ...
      intro: "Información sobre cómo se tratan los datos personales en Norek.",
      sections: [
        {
          title: "1. Responsable",
          paragraphs: [
    ...
    widerruf: {
      ...
      intro: "Información sobre el derecho legal de desistimiento en Norek.",
      sections: [
        {
          title: "Política de desistimiento",
          paragraphs: [
    ...
    preise: {
      ...
      intro: "Resumen de precios, comisiones y mecánica básica de pagos en Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Salvo que se indique expresamente lo contrario, los pagos de apoyo no son donaciones deducibles fiscalmente, sino pagos relacionados con la plataforma dentro de la mecánica de Norek.",
          ],
        },
      ],
    },
    ...
    auszahlungsrichtlinie: {
      ...
      intro: "Reglas y requisitos para los pagos en Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Norek puede retener, revisar, rechazar o corregir pagos cuando ello sea necesario por motivos legales, regulatorios, técnicos, de seguridad o contractuales.",
        ...
        },
        {
          ...
          paragraphs: [
            "Los destinatarios de pagos son los únicos responsables de clasificar y declarar correctamente las cantidades recibidas a efectos fiscales. Norek no proporciona asesoramiento fiscal individual.",
          ],
        },
        {
          title: "6. Recuperación / compensación",
          paragraphs: [
            "Norek puede reclamar pagos incorrectos o no autorizados, compensarlos con pagos futuros o revertirlos a través del proveedor de pagos en la medida permitida por la ley.",
          ],
        },
      ],
    },
  ...
  fr: {
    impressum: {
      ...
      intro: "Informations sur l’éditeur et les entités responsables de Norek.",
      sections: [
        {
    ...
    datenschutz: {
      ...
      intro: "Informations sur la manière dont les données personnelles sont traitées sur Norek.",
      sections: [
        {
    ...
    widerruf: {
      ...
      intro: "Informations sur le droit légal de rétractation sur Norek.",
      sections: [
        {
          title: "Politique de rétractation",
          paragraphs: [
    ...
    preise: {
      ...
      intro: "Aperçu des prix, frais et mécanismes de paiement de base sur Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Sauf indication expresse contraire, les paiements de soutien ne constituent pas des dons fiscalement déductibles, mais des paiements liés à la plateforme dans le cadre du mécanisme Norek.",
          ],
        },
      ],
    },
    ...
    auszahlungsrichtlinie: {
      ...
      intro: "Règles et conditions pour les versements sur Norek.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Norek peut retenir, contrôler, refuser ou corriger des versements lorsque cela est nécessaire pour des raisons juridiques, réglementaires, techniques, de sécurité ou contractuelles.",
        ...
        },
        {
          ...
          paragraphs: [
            "Les bénéficiaires des versements sont seuls responsables de la qualification et de la déclaration correcte des montants reçus à des fins fiscales. Norek ne fournit aucun conseil fiscal individuel.",
          ],
        },
        {
          title: "6. Récupération / compensation",
          paragraphs: [
            "Norek peut récupérer les versements erronés ou non autorisés, les compenser avec de futurs versements ou les annuler via le prestataire de paiement dans la mesure permise par la loi.",
          ],
        },
      ],
    },
...
export const agbPageMeta: Record<ChallengeLocale, LegalPageMeta> = {
  de: {
    ...
    intro:
      "Diese Fassung ist als starke Plattform-AGB für Norek aufgebaut. Ersetze vor Livegang alle Platzhalter durch deine echten Firmendaten.",
    badges: [
      "Stand: März 2026",
      "Für Website & App",
  ...
  en: {
    ...
    intro:
      "This version is structured as a strong platform terms document for Norek. Replace all placeholders with your real company data before going live.",
    badges: [
      "Version: March 2026",
      "For website & app",
  ...
  es: {
    ...
    intro:
      "Esta versión está estructurada como unos términos sólidos de plataforma para Norek. Sustituye todos los marcadores por los datos reales de tu empresa antes del lanzamiento.",
    badges: [
  ...
  fr: {
    ...
    intro:
      "Cette version est structurée comme des conditions générales solides pour la plateforme Norek. Remplace tous les champs réservés par les vraies données de ton entreprise avant la mise en ligne.",
    badges: [
      "Version : mars 2026",
  ...
  de: [
    {
      ...
      paragraphs: [
        "1.1 Diese Allgemeinen Geschäftsbedingungen regeln die Nutzung der von [UNTERNEHMENSNAME] betriebenen Plattform „Norek“ über Website und/oder App.",
        "1.2 Norek ist eine digitale Plattform, auf der Nutzer Challenges erstellen, Challenges unterstützen, an Challenges teilnehmen, Inhalte einreichen, Inhalte bewerten und – vorbehaltlich der jeweils geltenden Regeln – Auszahlungen erhalten können.",
        "1.3 Diese AGB gelten für alle Verträge zwischen Norek und den Nutzern in ihrer jeweils zum Zeitpunkt des Vertragsschlusses gültigen Fassung.",
        "1.4 Nutzer im Sinne dieser AGB können Verbraucher oder Unternehmer sein.",
        "1.5 Abweichende Geschäftsbedingungen von Nutzern werden nicht Vertragsbestandteil, es sei denn, Norek stimmt ihrer Geltung ausdrücklich schriftlich zu.",
      ],
    },
    {
      title: "2. Anbieter",
    ...
    {
      title: "3. Leistungen von Norek",
      paragraphs: [
        "3.1 Norek stellt eine technische Plattform zur Verfügung, auf der Nutzer Challenges erstellen, Challenges unterstützen, an Challenges teilnehmen, Beiträge hochladen oder live einreichen und Community-Funktionen nutzen können.",
        "3.2 Norek schuldet keinen bestimmten wirtschaftlichen Erfolg, keine Mindestanzahl von Teilnehmern, keine Mindesthöhe von Unterstützungsbeträgen und keine Auszahlung, sofern die Voraussetzungen der jeweiligen Challenge-Regeln nicht vollständig erfüllt sind.",
        "3.3 Norek ist berechtigt, die Plattform technisch, optisch und funktional weiterzuentwickeln, sofern dadurch wesentliche vertragliche Hauptpflichten nicht unzumutbar beeinträchtigt werden.",
        "3.4 Norek stellt die technische und organisatorische Plattforminfrastruktur bereit.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "4.3 Pro Person ist nur ein Nutzerkonto zulässig, sofern Norek nicht ausdrücklich mehrere Konten erlaubt.",
        "4.4 Zugangsdaten sind geheim zu halten und vor dem Zugriff Dritter zu schützen.",
        "4.5 Norek ist berechtigt, Nutzerkonten vorübergehend zu sperren oder endgültig zu schließen, wenn falsche Angaben gemacht wurden, ein Verstoß gegen diese AGB vorliegt, der Verdacht missbräuchlicher Nutzung besteht oder gesetzliche bzw. regulatorische Pflichten dies erfordern.",
      ],
    },
    {
      title: "5. Altersgrenzen, Verifikation und Teilnahmevoraussetzungen",
      paragraphs: [
        "5.1 Die Nutzung von Norek ist nur volljährigen Personen gestattet, soweit nicht einzelne Funktionen ausdrücklich auch Minderjährigen erlaubt werden.",
        "5.2 Norek ist berechtigt, für einzelne Challenges, Kategorien oder Auszahlungsfunktionen zusätzliche Alters-, Identitäts- oder Verifikationsnachweise zu verlangen.",
        ...
        "5.4 Norek ist berechtigt, Teilnahme- oder Auszahlungsrechte bis zum vollständigen Abschluss einer erforderlichen Verifikation auszusetzen.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "6.3 Challenges dürfen insbesondere nicht gegen geltendes Recht verstoßen, irreführend oder betrügerisch sein, zu Selbst- oder Fremdgefährdung aufrufen, Rechte Dritter verletzen oder sonst gegen die Community-Regeln von Norek verstoßen.",
        "6.4 Norek ist berechtigt, Challenges vor oder nach Veröffentlichung ganz oder teilweise abzulehnen, zu sperren, zu entfernen oder zu bearbeiten, soweit dies zur Einhaltung gesetzlicher Vorgaben, zum Schutz der Plattform oder zur Durchsetzung der Plattformregeln erforderlich ist.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "7.3 Norek ist berechtigt, Teilnahmeversuche abzulehnen, zu sperren, als ungültig zu kennzeichnen oder zu disqualifizieren, wenn die Challenge-Regeln nicht eingehalten wurden, Inhalte manipuliert oder technisch unzulässig sind, Sicherheits-, Alters- oder Verifikationsanforderungen nicht erfüllt wurden oder ein sonstiger Verstoß gegen diese AGB vorliegt.",
        "7.4 Soweit eine Challenge eine Live-Teilnahme oder eine verifizierte In-App-Aufnahme verlangt, ist ausschließlich die von Norek vorgegebene technische Einreichungsform maßgeblich.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "8.3 Mit erfolgreichem Abschluss des Zahlungsvorgangs beginnt Norek – vorbehaltlich technischer oder rechtlicher Hindernisse – unverzüglich mit der challengebezogenen Ausführung der geschuldeten Plattformleistung, insbesondere mit der Entgegennahme, Verbuchung, challengebezogenen Zuordnung, Verwaltung und weiteren Abwicklungsverarbeitung der Unterstützungszahlung.",
        ...
        "8.5 Eine Rückzahlung erfolgt nur, wenn Norek hierzu gesetzlich verpflichtet ist, wenn die Zahlung technisch oder rechtlich nicht wirksam verarbeitet werden konnte, wenn Norek sich aus Kulanz ausdrücklich mit einer Rückzahlung einverstanden erklärt oder wenn eine Rückabwicklung im Zusammenhang mit Chargebacks, Disputes, Zahlungsstörungen, Missbrauchsverdacht, Regelverstößen oder behördlichen Anforderungen erforderlich ist.",
        ...
        "8.7 Norek bleibt berechtigt, challengebezogene Beträge ganz oder teilweise zurückzuhalten, neu zuzuordnen, zu sperren oder rückabzuwickeln, wenn dies im Zusammenhang mit Missbrauch, Rechtsverstößen, Regelverstößen, Zahlungsstörungen, Disputes oder zwingenden gesetzlichen Vorgaben erforderlich ist.",
      ],
    },
    {
      title: "9. Plattformgebühren und Zahlungsabwicklung",
      paragraphs: [
        "9.1 Norek ist berechtigt, für die Nutzung der Plattform, die Bereitstellung technischer Infrastruktur, die Challenge-Abwicklung, Zahlungsabwicklung und Auszahlungsorganisation Plattformgebühren zu erheben.",
        "9.2 Norek kann sich zur Zahlungsabwicklung externer Zahlungsdienstleister bedienen.",
        "9.3 Es gelten ergänzend die Bedingungen des jeweils eingebundenen Zahlungsdienstleisters.",
        "9.4 Norek ist berechtigt, Gebührenmodelle anzupassen, soweit dies für Nutzer zumutbar ist und die Änderungen vor ihrer Anwendung transparent kommuniziert werden.",
    ...
    },
    {
      ...
      paragraphs: [
        "11.1 Norek ist berechtigt, challengebezogene Beträge ganz oder teilweise zurückzuhalten, neu zuzuordnen, mit späteren Ansprüchen zu verrechnen oder rückabzuwickeln, soweit dies im Zusammenhang mit Rückerstattungen, Zahlungsstörungen, Chargebacks, Disputes, Missbrauch, Regelverstößen oder rechtlichen Verpflichtungen erforderlich ist.",
        "11.2 Soweit bereits Auszahlungen erfolgt sind und sich nachträglich herausstellt, dass die Voraussetzungen für die Auszahlung nicht vorlagen oder Beträge ganz oder teilweise zurückabzuwickeln sind, kann Norek Rückforderungsansprüche geltend machen oder entsprechende Beträge mit zukünftigen Ansprüchen verrechnen.",
        "11.3 Nutzer sind verpflichtet, Norek bei der Aufklärung von Zahlungsstörungen und Disputes in zumutbarem Umfang zu unterstützen.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "12.2 Norek schuldet keine individuelle Steuer-, Rechts- oder Finanzberatung.",
        "12.3 Soweit Norek gesetzlich verpflichtet ist, bestimmte Informationen einzuholen, zu speichern, zu melden oder an Behörden oder Zahlungsdienstleister weiterzugeben, ist der Nutzer verpflichtet, die hierfür erforderlichen Angaben wahrheitsgemäß und vollständig zu machen.",
        "12.4 Norek ist berechtigt, Auszahlungen von der vorherigen Erfüllung solcher Pflichten abhängig zu machen.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "13.2 Der Nutzer kann im Bestellprozess ausdrücklich verlangen, dass Norek vor Ablauf der Widerrufsfrist mit der Ausführung der Plattformleistung beginnt.",
        "13.3 Soweit die gesetzlichen Voraussetzungen vorliegen, kann das Widerrufsrecht vorzeitig erlöschen, insbesondere wenn Norek die geschuldete Leistung vollständig erbracht hat und der Nutzer ausdrücklich zugestimmt hat, dass Norek vor Ablauf der Widerrufsfrist mit der Leistungsausführung beginnt, und seine Kenntnis davon bestätigt hat, dass er bei vollständiger Vertragserfüllung sein Widerrufsrecht verliert.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "14.2 Der Nutzer versichert, dass er an allen von ihm hochgeladenen oder genutzten Inhalten die erforderlichen Rechte besitzt und deren Nutzung auf Norek rechtlich zulässig ist.",
        "14.3 Der Nutzer räumt Norek an den eingestellten Inhalten die für Betrieb, Darstellung, Speicherung, Moderation, technische Verarbeitung, Promotion der Plattform und Durchführung der Challenge erforderlichen einfachen, räumlich unbeschränkten, übertragbaren Nutzungsrechte ein, soweit dies für die jeweiligen Zwecke erforderlich ist.",
        "14.4 Norek ist berechtigt, Inhalte zu kürzen, technisch anzupassen, in Vorschaubilder umzuwandeln, zu speichern, zu sichern und im Rahmen der Plattformfunktionen öffentlich zugänglich zu machen.",
    ...
    {
      title: "16. Moderation, Prüfungen und Maßnahmen von Norek",
      paragraphs: [
        "16.1 Norek ist berechtigt, Inhalte, Zahlungen, Challenges, Teilnehmerbeiträge und Nutzerkonten risikobasiert zu prüfen.",
        "16.2 Norek kann insbesondere folgende Maßnahmen ergreifen: Hinweis, Einschränkung einzelner Funktionen, temporäre Sperrung, Entfernung einzelner Inhalte, Aberkennung von Bewertungen oder Rangfolgen, Disqualifikation, Aussetzung oder Ablehnung von Auszahlungen, endgültige Kontosperrung.",
        "16.3 Norek trifft diese Maßnahmen nach pflichtgemäßem Ermessen unter Berücksichtigung der berechtigten Interessen aller Beteiligten.",
      ],
    },
    {
      title: "17. Verfügbarkeit",
      paragraphs: [
        "17.1 Norek bemüht sich um eine möglichst hohe Verfügbarkeit der Plattform.",
        "17.2 Eine ununterbrochene Verfügbarkeit wird nicht geschuldet.",
        "17.3 Norek ist berechtigt, die Plattform ganz oder teilweise wegen Wartung, Sicherheit, technischer Erfordernisse oder aus sonstigen sachlichen Gründen vorübergehend einzuschränken.",
      ],
    },
    {
      title: "18. Haftung",
      paragraphs: [
        "18.1 Norek haftet unbeschränkt bei Vorsatz und grober Fahrlässigkeit.",
        "18.2 Bei einfacher Fahrlässigkeit haftet Norek nur bei Verletzung einer wesentlichen Vertragspflicht; in diesem Fall ist die Haftung auf den vertragstypischen, vorhersehbaren Schaden begrenzt.",
        ...
        "18.4 Norek haftet nicht für von Nutzern eingestellte Inhalte, Angaben, Challenge-Beschreibungen oder tatsächliche Handlungen der Nutzer, soweit nicht eine eigene Verantwortlichkeit von Norek vorliegt.",
        "18.5 Norek haftet insbesondere nicht dafür, dass eine Challenge wirtschaftlich erfolgreich ist, genügend Unterstützer findet oder ein bestimmtes Preisgeldniveau erreicht.",
      ],
    },
    {
      title: "19. Freistellung",
      paragraphs: [
        "Der Nutzer stellt Norek von sämtlichen Ansprüchen Dritter frei, die aus einer rechtswidrigen Nutzung der Plattform, einem Verstoß gegen diese AGB, gegen Challenge-Regeln oder aus der Verletzung von Rechten Dritter durch den Nutzer resultieren, einschließlich der angemessenen Kosten der Rechtsverteidigung, es sei denn, der Nutzer hat die Pflichtverletzung nicht zu vertreten.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "20.3 Norek kann den Nutzungsvertrag ordentlich mit angemessener Frist kündigen.",
    ...
    },
    {
      ...
      paragraphs: [
        "21.1 Norek ist berechtigt, diese AGB mit Wirkung für die Zukunft zu ändern, soweit hierfür ein sachlicher Grund besteht, insbesondere bei Änderungen der Rechtslage, Änderungen der Plattformfunktionen, Änderungen der Zahlungs- oder Auszahlungsstruktur sowie Sicherheits- oder Missbrauchsanforderungen.",
        "21.2 Änderungen werden dem Nutzer rechtzeitig in geeigneter Form mitgeteilt.",
        "21.3 Widerspricht der Nutzer den Änderungen nicht innerhalb der von Norek gesetzten angemessenen Frist, gelten die Änderungen als angenommen, sofern Norek auf diese Folge zuvor ausdrücklich hingewiesen hat.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "22.3 Norek ist berechtigt, die Nutzerführung, Bestellstrecken und Widerrufsprozesse an geänderte gesetzliche Anforderungen anzupassen.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "23.2 Ist der Nutzer Kaufmann, juristische Person des öffentlichen Rechts oder öffentlich-rechtliches Sondervermögen, ist Gerichtsstand für alle Streitigkeiten aus oder im Zusammenhang mit diesen AGB der Sitz von Norek.",
  ...
  en: [
    {
      title: "1. Scope",
      paragraphs: [
        "1.1 These Terms and Conditions govern the use of the “Norek” platform operated by [COMPANY NAME] via website and/or app.",
        "1.2 Norek is a digital platform on which users can create challenges, support challenges, participate in challenges, submit content, rate content and — subject to the applicable rules — receive payouts.",
        "1.3 These Terms and Conditions apply to all contracts between Norek and the users in the version valid at the time the contract is concluded.",
        "1.4 Users within the meaning of these Terms and Conditions may be consumers or businesses.",
        "1.5 Deviating terms and conditions of users shall not become part of the contract unless Norek expressly agrees to their validity in writing.",
      ],
    },
    {
      title: "2. Provider",
    ...
    {
      title: "3. Services of Norek",
      paragraphs: [
        "3.1 Norek provides a technical platform on which users can create challenges, support challenges, participate in challenges, upload contributions or submit them live and use community features.",
        "3.2 Norek does not owe any specific economic success, any minimum number of participants, any minimum level of support payments or any payout, unless the requirements of the respective challenge rules have been fulfilled in full.",
        "3.3 Norek is entitled to further develop the platform technically, visually and functionally, provided that essential contractual obligations are not unreasonably impaired as a result.",
        "3.4 Norek provides the technical and organizational platform infrastructure.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "4.3 Only one user account is permitted per person unless Norek expressly allows multiple accounts.",
        "4.4 Access credentials must be kept secret and protected from access by third parties.",
        "4.5 Norek is entitled to temporarily block or permanently close user accounts if false information has been provided, these Terms and Conditions have been violated, there is suspicion of abusive use, or legal or regulatory obligations require such action.",
      ],
    },
    {
      title: "5. Age limits, verification and participation requirements",
      paragraphs: [
        "5.1 The use of Norek is permitted only for adults unless individual functions are expressly also permitted for minors.",
        "5.2 Norek is entitled to require additional age, identity or verification proof for individual challenges, categories or payout functions.",
        ...
        "5.4 Norek is entitled to suspend participation rights or payout rights until a required verification has been fully completed.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "6.3 In particular, challenges must not violate applicable law, be misleading or fraudulent, encourage self-endangerment or endangerment of others, infringe third-party rights or otherwise violate Norek’s community rules.",
        "6.4 Norek is entitled to reject, block, remove or edit challenges in whole or in part before or after publication insofar as this is necessary for compliance with legal requirements, protection of the platform or enforcement of the platform rules.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "7.3 Norek is entitled to reject, block, mark as invalid or disqualify participation attempts if the challenge rules have not been observed, content has been manipulated or is technically impermissible, security, age or verification requirements have not been met or any other violation of these Terms and Conditions exists.",
        "7.4 Where a challenge requires live participation or a verified in-app recording, only the technical submission format specified by Norek shall be decisive.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "8.5 A refund shall only be made if Norek is legally obliged to do so, if the payment could not be processed effectively for technical or legal reasons, if Norek expressly agrees to a refund as a gesture of goodwill, or if a reversal is required in connection with chargebacks, disputes, payment disruptions, suspected abuse, rule violations or official requirements.",
        ...
        "8.7 Norek remains entitled to withhold, reallocate, block or reverse challenge-related amounts in whole or in part if this is necessary in connection with abuse, legal violations, rule violations, payment disruptions, disputes or mandatory statutory requirements.",
      ],
    },
    {
      title: "9. Platform fees and payment processing",
      paragraphs: [
        "9.1 Norek is entitled to charge platform fees for the use of the platform, the provision of technical infrastructure, challenge handling, payment processing and payout organization.",
        "9.2 Norek may use external payment service providers for payment processing.",
        "9.3 The terms of the respectively integrated payment service provider shall apply additionally.",
        "9.4 Norek is entitled to adjust fee models insofar as this is reasonable for users and the changes are communicated transparently before their application.",
    ...
    },
    {
      ...
      paragraphs: [
        "10.1 A claim to payout arises only if the respective challenge has been effectively completed, a winner has been effectively determined according to the challenge rules, no blocking, disqualification, abuse or review reason exists and the user has fulfilled all verification, identification and payout requirements requested by Norek or the payment service provider.",
        "10.2 Norek is entitled to withhold, delay or reject payouts in whole or in part if legal or regulatory requirements demand this, if there are uncertainties about entitlement, if refunds, disputes, chargebacks or suspicion of fraud exist, or if the user has violated these Terms and Conditions or challenge rules.",
        "10.3 Norek may process payouts via connected payment or connected account structures.",
    ...
    },
    {
      ...
      paragraphs: [
        "11.1 Norek is entitled to withhold, reallocate, set off against later claims or reverse challenge-related amounts in whole or in part insofar as this is necessary in connection with refunds, payment disruptions, chargebacks, disputes, abuse, rule violations or legal obligations.",
        "11.2 Where payouts have already been made and it later turns out that the requirements for payout were not met or amounts must be reversed in whole or in part, Norek may assert repayment claims or offset the respective amounts against future claims.",
        "11.3 Users are obliged to support Norek to a reasonable extent in clarifying payment disruptions and disputes.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "12.2 Norek does not owe individual tax, legal or financial advice.",
        "12.3 Where Norek is legally obliged to collect, store, report or pass on certain information to authorities or payment service providers, the user is obliged to provide the necessary information truthfully and completely.",
        "12.4 Norek is entitled to make payouts dependent on the prior fulfillment of such obligations.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "13.2 In the order process, the user may expressly request that Norek begin performance of the platform service before expiry of the withdrawal period.",
        "13.3 Insofar as the statutory requirements are met, the right of withdrawal may expire early, in particular if Norek has fully performed the owed service and the user has expressly agreed that Norek begins performing the service before expiry of the withdrawal period and has confirmed awareness that they lose their right of withdrawal upon full contract performance.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "14.2 The user warrants that they possess all necessary rights to the content uploaded or used by them and that its use on Norek is legally permissible.",
        "14.3 The user grants Norek the simple, territorially unlimited, transferable rights of use to the uploaded content necessary for the operation, display, storage, moderation, technical processing, promotion of the platform and execution of the challenge, insofar as this is necessary for the respective purposes.",
        "14.4 Norek is entitled to shorten content, technically adapt it, convert it into preview images, store it, secure it and make it publicly accessible within the scope of the platform functions.",
    ...
    {
      title: "16. Moderation, reviews and measures by Norek",
      paragraphs: [
        "16.1 Norek is entitled to review content, payments, challenges, participant contributions and user accounts on a risk-based basis.",
        "16.2 Norek may in particular take the following measures: warning, restriction of individual functions, temporary suspension, removal of individual content, revocation of ratings or rankings, disqualification, suspension or rejection of payouts, permanent account suspension.",
        "16.3 Norek shall take these measures at its duly exercised discretion taking into account the legitimate interests of all parties involved.",
      ],
    },
    {
      title: "17. Availability",
      paragraphs: [
        "17.1 Norek endeavors to ensure the highest possible availability of the platform.",
        "17.2 Continuous availability is not owed.",
        "17.3 Norek is entitled to restrict the platform in whole or in part temporarily for maintenance, security, technical requirements or other objective reasons.",
      ],
    },
    {
      title: "18. Liability",
      paragraphs: [
        "18.1 Norek shall be liable without limitation in cases of intent and gross negligence.",
        "18.2 In cases of slight negligence, Norek shall be liable only in the event of breach of an essential contractual obligation; in this case liability is limited to the typical foreseeable damage.",
        ...
        "18.4 Norek shall not be liable for content, information, challenge descriptions or actual acts posted by users unless Norek itself is responsible for them.",
        "18.5 In particular, Norek shall not be liable for a challenge being economically successful, finding enough supporters or reaching a certain prize level.",
      ],
    },
    {
      title: "19. Indemnification",
      paragraphs: [
        "The user shall indemnify Norek against all third-party claims arising from unlawful use of the platform, a breach of these Terms and Conditions, breach of challenge rules or infringement of third-party rights by the user, including reasonable legal defense costs, unless the user is not responsible for the breach of duty.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "20.3 Norek may terminate the user agreement by ordinary notice with a reasonable period of notice.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "22.3 Norek is entitled to adapt the user guidance, order flows and withdrawal processes to changed legal requirements.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "23.2 If the user is a merchant, a legal entity under public law or a special fund under public law, the place of jurisdiction for all disputes arising from or in connection with these Terms and Conditions shall be the registered office of Norek.",
  ...
  es: [
    {
      ...
      paragraphs: [
        "1.1 Estas Condiciones Generales regulan el uso de la plataforma “Norek” operada por [NOMBRE DE LA EMPRESA] a través del sitio web y/o la app.",
        "1.2 Norek es una plataforma digital en la que los usuarios pueden crear retos, apoyar retos, participar en retos, enviar contenidos, valorar contenidos y — con sujeción a las reglas aplicables — recibir pagos.",
        "1.3 Estas Condiciones Generales se aplican a todos los contratos entre Norek y los usuarios en la versión vigente en el momento de la celebración del contrato.",
        "1.4 Los usuarios en el sentido de estas Condiciones Generales pueden ser consumidores o empresas.",
        "1.5 Las condiciones divergentes de los usuarios no pasarán a formar parte del contrato, salvo que Norek acepte expresamente su validez por escrito.",
      ],
    },
    {
      title: "2. Proveedor",
    ...
    {
      title: "3. Servicios de Norek",
      paragraphs: [
        "3.1 Norek pone a disposición una plataforma técnica en la que los usuarios pueden crear retos, apoyar retos, participar en retos, subir contribuciones o enviarlas en directo y utilizar funciones de comunidad.",
        "3.2 Norek no debe ningún éxito económico concreto, ningún número mínimo de participantes, ningún nivel mínimo de pagos de apoyo ni ningún pago, salvo que se hayan cumplido íntegramente los requisitos de las reglas del reto correspondiente.",
        "3.3 Norek está autorizada a seguir desarrollando la plataforma a nivel técnico, visual y funcional, siempre que ello no perjudique de forma irrazonable las obligaciones contractuales esenciales.",
        "3.4 Norek proporciona la infraestructura técnica y organizativa de la plataforma.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "4.3 Solo se permite una cuenta de usuario por persona, salvo que Norek autorice expresamente varias cuentas.",
        "4.4 Las credenciales de acceso deben mantenerse en secreto y protegerse frente al acceso de terceros.",
        "4.5 Norek está autorizada a bloquear temporalmente o cerrar definitivamente cuentas de usuario si se han facilitado datos falsos, si existe una infracción de estas Condiciones Generales, si existe sospecha de uso abusivo o si obligaciones legales o regulatorias lo exigen.",
      ],
    },
    {
      title: "5. Límites de edad, verificación y requisitos de participación",
      paragraphs: [
        "5.1 El uso de Norek solo está permitido a personas mayores de edad, salvo que determinadas funciones se permitan expresamente también a menores.",
        "5.2 Norek está autorizada a exigir pruebas adicionales de edad, identidad o verificación para determinados retos, categorías o funciones de pago.",
        ...
        "5.4 Norek está autorizada a suspender derechos de participación o de cobro hasta que una verificación requerida haya concluido por completo.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "6.3 En particular, los retos no deben infringir la legislación aplicable, ser engañosos o fraudulentos, incitar a ponerse en peligro a uno mismo o a terceros, vulnerar derechos de terceros ni infringir de cualquier otro modo las normas de la comunidad de Norek.",
        "6.4 Norek está autorizada a rechazar, bloquear, eliminar o modificar retos, total o parcialmente, antes o después de su publicación, en la medida en que ello sea necesario para cumplir requisitos legales, proteger la plataforma o aplicar las normas de la plataforma.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "8.3 Una vez completado con éxito el proceso de pago, Norek comenzará de inmediato — salvo impedimentos técnicos o legales — la ejecución de la prestación de plataforma vinculada al reto, en particular la recepción, contabilización, asignación al reto, gestión y posterior tratamiento del pago de apoyo.",
        ...
        "8.5 Solo se efectuará un reembolso si Norek está legalmente obligada a ello, si el pago no pudo procesarse de manera válida por razones técnicas o legales, si Norek acepta expresamente un reembolso por cortesía o si una reversión es necesaria en relación con chargebacks, disputas, incidencias de pago, sospecha de abuso, infracciones de reglas o requerimientos de autoridades.",
        ...
        "8.7 Norek seguirá estando autorizada a retener, reasignar, bloquear o revertir, total o parcialmente, importes vinculados a un reto cuando ello sea necesario en relación con abuso, infracciones legales, infracciones de reglas, incidencias de pago, disputas o requisitos legales imperativos.",
      ],
    },
    {
      title: "9. Comisiones de plataforma y procesamiento de pagos",
      paragraphs: [
        "9.1 Norek está autorizada a cobrar comisiones de plataforma por el uso de la plataforma, la puesta a disposición de infraestructura técnica, la gestión de retos, el procesamiento de pagos y la organización de pagos.",
        "9.2 Norek puede utilizar proveedores externos de servicios de pago para el procesamiento de pagos.",
        "9.3 Se aplicarán adicionalmente las condiciones del proveedor de pagos integrado en cada caso.",
        "9.4 Norek está autorizada a adaptar los modelos de comisiones siempre que ello resulte razonable para los usuarios y los cambios se comuniquen de forma transparente antes de su aplicación.",
    ...
    },
    {
      ...
      paragraphs: [
        "11.1 Norek está autorizada a retener, reasignar, compensar con créditos futuros o revertir, total o parcialmente, importes vinculados a retos cuando ello sea necesario en relación con reembolsos, incidencias de pago, chargebacks, disputas, abuso, infracciones de reglas u obligaciones legales.",
        "11.2 Si ya se hubieran efectuado pagos y posteriormente resultara que no se cumplían los requisitos para el cobro o que los importes deben revertirse total o parcialmente, Norek podrá reclamar su devolución o compensar los importes correspondientes con derechos futuros.",
        "11.3 Los usuarios están obligados a colaborar con Norek de manera razonable en la aclaración de incidencias de pago y disputas.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "12.2 Norek no presta asesoramiento fiscal, jurídico ni financiero individual.",
        "12.3 En la medida en que Norek esté legalmente obligada a recabar, almacenar, comunicar o transmitir determinada información a autoridades o proveedores de pago, el usuario está obligado a facilitar la información necesaria de forma veraz y completa.",
        "12.4 Norek está autorizada a supeditar los pagos al cumplimiento previo de tales obligaciones.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "13.2 En el proceso de pedido, el usuario puede solicitar expresamente que Norek comience a ejecutar la prestación de la plataforma antes de que finalice el plazo de desistimiento.",
        "13.3 Siempre que se cumplan los requisitos legales, el derecho de desistimiento puede extinguirse anticipadamente, en particular si Norek ha prestado íntegramente el servicio debido y el usuario ha aceptado expresamente que Norek comience la ejecución antes de que finalice el plazo de desistimiento y ha confirmado conocer que pierde su derecho de desistimiento con el cumplimiento íntegro del contrato.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "14.2 El usuario garantiza que posee todos los derechos necesarios sobre los contenidos subidos o utilizados por él y que su uso en Norek es legalmente admisible.",
        "14.3 El usuario concede a Norek los derechos de uso simples, transferibles y sin limitación territorial necesarios sobre los contenidos publicados para el funcionamiento, la visualización, el almacenamiento, la moderación, el tratamiento técnico, la promoción de la plataforma y la ejecución del reto, en la medida necesaria para las finalidades correspondientes.",
        "14.4 Norek está autorizada a acortar contenidos, adaptarlos técnicamente, convertirlos en imágenes de vista previa, almacenarlos, asegurarlos y hacerlos públicamente accesibles dentro del marco de las funciones de la plataforma.",
    ...
    {
      title: "16. Moderación, revisiones y medidas de Norek",
      paragraphs: [
        "16.1 Norek está autorizada a revisar, en función del riesgo, contenidos, pagos, retos, contribuciones de participantes y cuentas de usuario.",
        "16.2 Norek podrá adoptar, en particular, las siguientes medidas: advertencia, limitación de funciones concretas, bloqueo temporal, eliminación de contenidos concretos, retirada de valoraciones o clasificaciones, descalificación, suspensión o rechazo de pagos, bloqueo definitivo de la cuenta.",
        "16.3 Norek adoptará estas medidas a su discreción debidamente ejercida, teniendo en cuenta los intereses legítimos de todas las partes implicadas.",
      ],
    },
    {
      title: "17. Disponibilidad",
      paragraphs: [
        "17.1 Norek se esfuerza por garantizar la máxima disponibilidad posible de la plataforma.",
        "17.2 No se debe una disponibilidad ininterrumpida.",
        "17.3 Norek está autorizada a restringir temporalmente total o parcialmente la plataforma por motivos de mantenimiento, seguridad, requisitos técnicos u otras razones objetivas.",
      ],
    },
    {
      title: "18. Responsabilidad",
      paragraphs: [
        "18.1 Norek responderá sin limitación en caso de dolo y negligencia grave.",
        "18.2 En caso de negligencia leve, Norek solo responderá por el incumplimiento de una obligación contractual esencial; en este caso la responsabilidad se limita al daño previsible y típico del contrato.",
        ...
        "18.4 Norek no responderá por contenidos, datos, descripciones de retos o actos efectivos publicados por usuarios, salvo que exista una responsabilidad propia de Norek.",
        "18.5 En particular, Norek no responderá de que un reto tenga éxito económico, encuentre suficientes apoyos o alcance un determinado nivel de premio.",
      ],
    },
    {
      title: "19. Indemnización",
      paragraphs: [
        "El usuario indemnizará a Norek frente a cualesquiera reclamaciones de terceros derivadas de un uso ilícito de la plataforma, de una infracción de estas Condiciones Generales, de las reglas de los retos o de la vulneración de derechos de terceros por parte del usuario, incluidos los costes razonables de defensa jurídica, salvo que el usuario no sea responsable de la infracción.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "20.3 Norek podrá resolver ordinariamente el contrato de uso con un preaviso razonable.",
    ...
    },
    {
      ...
      paragraphs: [
        "21.1 Norek está autorizada a modificar estas Condiciones Generales con efectos para el futuro siempre que exista un motivo objetivo para ello, en particular cambios en la situación legal, cambios en las funciones de la plataforma, cambios en la estructura de pagos o cobros o exigencias de seguridad o prevención de abusos.",
        "21.2 Las modificaciones se comunicarán al usuario de forma adecuada y con antelación suficiente.",
        "21.3 Si el usuario no se opone a las modificaciones dentro del plazo razonable fijado por Norek, las modificaciones se considerarán aceptadas, siempre que Norek haya informado expresamente de esta consecuencia con anterioridad.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "22.3 Norek está autorizada a adaptar la guía de usuario, los flujos de pedido y los procesos de desistimiento a cambios en los requisitos legales.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "23.2 Si el usuario es comerciante, persona jurídica de derecho público o patrimonio especial de derecho público, el fuero para todas las controversias derivadas de estas Condiciones Generales o relacionadas con ellas será el domicilio social de Norek.",
  ...
  fr: [
    {
      ...
      paragraphs: [
        "1.1 Les présentes Conditions Générales régissent l’utilisation de la plateforme « Norek » exploitée par [NOM DE L’ENTREPRISE] via le site web et/ou l’application.",
        "1.2 Norek est une plateforme numérique sur laquelle les utilisateurs peuvent créer des défis, soutenir des défis, participer à des défis, soumettre du contenu, évaluer du contenu et — sous réserve des règles applicables — recevoir des paiements.",
        "1.3 Les présentes Conditions Générales s’appliquent à tous les contrats conclus entre Norek et les utilisateurs dans leur version en vigueur au moment de la conclusion du contrat.",
        "1.4 Les utilisateurs au sens des présentes Conditions Générales peuvent être des consommateurs ou des entreprises.",
        "1.5 Les conditions divergentes des utilisateurs ne deviennent pas partie intégrante du contrat, sauf si Norek accepte expressément leur validité par écrit.",
      ],
    },
    {
      title: "2. Fournisseur",
    ...
    {
      title: "3. Services de Norek",
      paragraphs: [
        "3.1 Norek met à disposition une plateforme technique sur laquelle les utilisateurs peuvent créer des défis, soutenir des défis, participer à des défis, téléverser des contributions ou les soumettre en direct et utiliser des fonctions communautaires.",
        "3.2 Norek ne garantit aucun succès économique déterminé, aucun nombre minimal de participants, aucun niveau minimal de paiements de soutien ni aucun versement, sauf si les conditions des règles du défi concerné sont intégralement remplies.",
        "3.3 Norek est autorisée à développer davantage la plateforme sur les plans technique, visuel et fonctionnel, à condition que les obligations contractuelles essentielles ne soient pas affectées de manière déraisonnable.",
        "3.4 Norek fournit l’infrastructure technique et organisationnelle de la plateforme.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "4.3 Un seul compte utilisateur est autorisé par personne, sauf si Norek autorise expressément plusieurs comptes.",
        "4.4 Les identifiants d’accès doivent rester secrets et être protégés contre l’accès de tiers.",
        "4.5 Norek est autorisée à bloquer temporairement ou à fermer définitivement des comptes utilisateurs si de fausses informations ont été fournies, s’il existe une violation des présentes Conditions Générales, un soupçon d’utilisation abusive ou si des obligations légales ou réglementaires l’exigent.",
      ],
    },
    {
      title: "5. Limites d’âge, vérification et conditions de participation",
      paragraphs: [
        "5.1 L’utilisation de Norek est réservée aux personnes majeures, sauf si certaines fonctions sont expressément également autorisées aux mineurs.",
        "5.2 Norek est autorisée à exiger des justificatifs supplémentaires d’âge, d’identité ou de vérification pour certains défis, catégories ou fonctions de versement.",
        ...
        "5.4 Norek est autorisée à suspendre les droits de participation ou de versement jusqu’à l’achèvement complet d’une vérification requise.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "6.3 Les défis ne doivent notamment pas enfreindre le droit applicable, être trompeurs ou frauduleux, inciter à une mise en danger de soi-même ou d’autrui, porter atteinte aux droits de tiers ou enfreindre d’une autre manière les règles de la communauté de Norek.",
        "6.4 Norek est autorisée à refuser, bloquer, supprimer ou modifier des défis en tout ou en partie avant ou après leur publication dans la mesure où cela est nécessaire pour respecter les exigences légales, protéger la plateforme ou faire appliquer les règles de la plateforme.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "7.4 Lorsqu’un défi exige une participation en direct ou un enregistrement vérifié dans l’application, seul le format technique de soumission imposé par Norek fait foi.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "8.3 Après la réussite du processus de paiement, Norek commence immédiatement — sous réserve d’obstacles techniques ou juridiques — l’exécution de la prestation de plateforme due en lien avec le défi, notamment la réception, l’enregistrement comptable, l’affectation au défi, la gestion et le traitement ultérieur du paiement de soutien.",
        ...
        "8.5 Un remboursement n’intervient que si Norek y est légalement tenue, si le paiement n’a pas pu être traité valablement pour des raisons techniques ou juridiques, si Norek accepte expressément un remboursement à titre commercial ou si une rétrofacturation est nécessaire en lien avec des chargebacks, litiges, perturbations de paiement, soupçons d’abus, violations des règles ou exigences des autorités.",
        ...
        "8.7 Norek demeure autorisée à retenir, réaffecter, bloquer ou annuler en tout ou en partie des montants liés à un défi si cela est nécessaire en lien avec des abus, violations du droit, violations des règles, perturbations de paiement, litiges ou exigences légales impératives.",
      ],
    },
    {
      title: "9. Frais de plateforme et traitement des paiements",
      paragraphs: [
        "9.1 Norek est autorisée à percevoir des frais de plateforme pour l’utilisation de la plateforme, la mise à disposition de l’infrastructure technique, la gestion des défis, le traitement des paiements et l’organisation des versements.",
        "9.2 Norek peut recourir à des prestataires externes de services de paiement pour le traitement des paiements.",
        "9.3 Les conditions du prestataire de paiement intégré dans chaque cas s’appliquent en complément.",
        "9.4 Norek est autorisée à adapter les modèles de frais dans la mesure où cela est raisonnable pour les utilisateurs et où les modifications sont communiquées de manière transparente avant leur application.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "10.3 Norek peut traiter les versements via des structures de paiement connectées ou connected accounts.",
    ...
    },
    {
      ...
      paragraphs: [
        "11.1 Norek est autorisée à retenir, réaffecter, compenser avec des créances ultérieures ou annuler en tout ou en partie des montants liés à des défis si cela est nécessaire en lien avec des remboursements, perturbations de paiement, chargebacks, litiges, abus, violations des règles ou obligations légales.",
        "11.2 Si des versements ont déjà été effectués et qu’il s’avère ultérieurement que les conditions du versement n’étaient pas remplies ou que des montants doivent être annulés en tout ou en partie, Norek peut faire valoir des droits au remboursement ou compenser les montants concernés avec des créances futures.",
        "11.3 Les utilisateurs sont tenus d’aider Norek dans une mesure raisonnable à clarifier les perturbations de paiement et les litiges.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "12.2 Norek ne fournit aucun conseil fiscal, juridique ou financier individuel.",
        "12.3 Dans la mesure où Norek est légalement tenue de recueillir, conserver, déclarer ou transmettre certaines informations aux autorités ou aux prestataires de paiement, l’utilisateur est tenu de fournir les informations nécessaires de manière véridique et complète.",
        "12.4 Norek est autorisée à subordonner les versements au respect préalable de telles obligations.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "13.2 Lors du processus de commande, l’utilisateur peut expressément demander que Norek commence l’exécution de la prestation de plateforme avant l’expiration du délai de rétractation.",
        "13.3 Dans la mesure où les conditions légales sont remplies, le droit de rétractation peut s’éteindre de manière anticipée, notamment si Norek a entièrement exécuté la prestation due et que l’utilisateur a expressément accepté que Norek commence l’exécution avant l’expiration du délai de rétractation et a confirmé avoir connaissance du fait qu’il perd son droit de rétractation en cas d’exécution complète du contrat.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "14.2 L’utilisateur garantit qu’il détient tous les droits nécessaires sur les contenus qu’il téléverse ou utilise et que leur utilisation sur Norek est juridiquement autorisée.",
        "14.3 L’utilisateur accorde à Norek les droits d’utilisation simples, transférables et sans limitation territoriale nécessaires sur les contenus publiés pour l’exploitation, l’affichage, le stockage, la modération, le traitement technique, la promotion de la plateforme et l’exécution du défi, dans la mesure nécessaire aux finalités concernées.",
        "14.4 Norek est autorisée à raccourcir des contenus, les adapter techniquement, les convertir en images d’aperçu, les stocker, les sécuriser et les rendre publiquement accessibles dans le cadre des fonctions de la plateforme.",
    ...
    {
      title: "16. Modération, contrôles et mesures de Norek",
      paragraphs: [
        "16.1 Norek est autorisée à contrôler, sur une base fondée sur le risque, les contenus, paiements, défis, contributions des participants et comptes utilisateurs.",
        "16.2 Norek peut notamment prendre les mesures suivantes : avertissement, restriction de certaines fonctions, suspension temporaire, suppression de contenus spécifiques, retrait d’évaluations ou de classements, disqualification, suspension ou refus de versements, blocage définitif du compte.",
        "16.3 Norek prend ces mesures selon son pouvoir d’appréciation dûment exercé en tenant compte des intérêts légitimes de toutes les parties concernées.",
      ],
    },
    {
      title: "17. Disponibilité",
      paragraphs: [
        "17.1 Norek s’efforce d’assurer la plus grande disponibilité possible de la plateforme.",
        "17.2 Une disponibilité ininterrompue n’est pas due.",
        "17.3 Norek est autorisée à restreindre temporairement tout ou partie de la plateforme pour des raisons de maintenance, de sécurité, d’exigences techniques ou d’autres raisons objectives.",
      ],
    },
    {
      title: "18. Responsabilité",
      paragraphs: [
        "18.1 Norek est responsable sans limitation en cas d’intention et de faute lourde.",
        "18.2 En cas de faute légère, Norek n’est responsable qu’en cas de violation d’une obligation contractuelle essentielle ; dans ce cas, la responsabilité est limitée au dommage typique et prévisible.",
        ...
        "18.4 Norek n’est pas responsable des contenus, informations, descriptions de défis ou actes effectifs publiés par les utilisateurs, sauf si Norek en est elle-même responsable.",
        "18.5 Norek n’est notamment pas responsable du fait qu’un défi connaisse un succès économique, trouve suffisamment de soutiens ou atteigne un certain niveau de prix.",
      ],
    },
    {
      title: "19. Garantie / indemnisation",
      paragraphs: [
        "L’utilisateur garantit et indemnise Norek contre toutes les réclamations de tiers résultant d’une utilisation illicite de la plateforme, d’une violation des présentes Conditions Générales, des règles des défis ou d’une atteinte aux droits de tiers par l’utilisateur, y compris les frais raisonnables de défense juridique, sauf si l’utilisateur n’est pas responsable de la violation.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "20.3 Norek peut résilier le contrat d’utilisation par voie ordinaire avec un préavis raisonnable.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "21.3 Si l’utilisateur ne s’oppose pas aux modifications dans le délai raisonnable fixé par Norek, les modifications sont réputées acceptées, à condition que Norek ait expressément attiré l’attention sur cette conséquence au préalable.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "22.3 Norek est autorisée à adapter la navigation utilisateur, les parcours de commande et les processus de rétractation aux évolutions des exigences légales.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "23.2 Si l’utilisateur est commerçant, personne morale de droit public ou fonds spécial de droit public, le tribunal compétent pour tous les litiges nés de ou en lien avec les présentes Conditions Générales est le siège de Norek.",
